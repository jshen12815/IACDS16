...
class GetBase64EncodedObjectInputSet(InputSet):
    ...
    def set_UserRegion(self, value):
        """
        Set the value of the UserRegion input for this Choreo. ((conditional, string) The AWS region that corresponds to the S3 endpoint you wish to access. The default region is "us-east-1".)
        """
        super(GetBase64EncodedObjectInputSet, self)._set_input('UserRegion', value)
...
class GetBase64EncodedObjectResultSet(ResultSet):
    ...
    def get_ETag(self):
        """
        Retrieve the value for the "ETag" output from this Choreo execution. ((string) The ETag string for the file.)
        """
        return self._output.get('ETag', None)
